...
//    predicate(Vehicle::class to Vehicle::class) { ctx, v0, v1 ->
//      eventually(v0, v1) { v0, v1 ->
//        globally(v0, v1, TickDataDifferenceSeconds(0.0) to TickDataDifferenceSeconds(30.0)) { v0,
// v1
//          ->
...
// val onSameLane = predicate(Actor::class to Actor::class) { _, a1, a2 -> a1.lane.uid ==
// a2.lane.uid }
//
/// **
// * pedestrian p is on the same lane es vehicle, v and v is driving towards p with a distance of <
// 10
// * meters.
// */
// val inReach =
...
//
/// **
// * v0 is behind v1 then besides v1 and then in front of v1. Both vehicles move with more than 10
// mph
// */
// val overtaking =
//    predicate(Vehicle::class to Vehicle::class) { ctx, v0, v1 ->
